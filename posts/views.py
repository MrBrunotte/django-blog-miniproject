...
def post_detail(request, pk):
    """
    Create a view that will return a single Post object based on the post ID (pk) and render it to the 'postdetail.html' template. Or return an 404 error if the post is not found.
    """
